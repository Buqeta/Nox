            ...
            <div class="right-div">
                <div class="form">
                    ...
                    <div class="input-form">
                        <form action="includes/registerVerify.php" id="loginForm" method="POST" onsubmit="return validate();"> 
                            ...
                            <div class="email_input">
                                <input type="email" class="inputs" id="email" name="email" placeholder="johnsmith@gmail.com" >
                                <span class="error"></span>
                            </div>
